...
dicx1={'11111':10000000,'22222':1000000,\
...
dicx2={'11111':10000000,'22222':100000000,\
...
lst=sorted(list(dicx1.keys()),key=lambda x:dicx1[x],reverse=True)
...
def find_pos(board,dicx):
    max_score=-1000
    posx,posy=0,0
    for i in range(0,15):
        for j in range(0,15):
            if has_neighbor(i,j,board) and board.matrix[i][j]=='0':
                score=cal_score(i,j,'1',board,dicx)+cal_score(i,j,'2',board,dicx)#! 可攻可守
...
def cal_score(x,y,color,board,dicx):
